...
- `Calculus/`: Chapter- and problem-indexed files with worked formal proofs from the Calculus text. Currently features nearly 300 stated problems spanning Chapters 1 through 13, with **98 problems fully verified** (zero admitted lemmas).
